...
app.post('/user', limiter, (req, res, next) => {
    ...
    // sus does not use nEmail
    // so we can kinda input many tuples of the form
    /*
        (normalizedMail,H(Mail1+random))
        (normalizedMail,H(Mail2+random))
        (normalizedMail,H(Mail3+random))
    
    but "normalizedMail" has the constraint UNIQUE!
    */
