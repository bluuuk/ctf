...
def create_shipment():
    ...
    shipment_status = subprocess.check_output(["go","run","/Users/bluk/Developer/ctf/UICTF25/web/shippingbay/processing_service/main.go", json.dumps(shipment_data)]).decode().strip()
