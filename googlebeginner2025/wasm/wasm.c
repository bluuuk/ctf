...
void wasm2c__instantiate(w2c_*, struct w2c_js*);
void wasm2c__free(w2c_*);
wasm_rt_func_type_t wasm2c__get_func_type(uint32_t param_count, uint32_t result_count, ...);

extern const u64 wasm2c__min_js_mem;
extern const u64 wasm2c__max_js_mem;
extern const u8 wasm2c__is64_js_mem;

/* export: 'encode' */
void w2c__encode(w2c_*, u32, u32);
...
static u32 w2c__f0(w2c_*, u32, u32);
static void w2c__encode_0(w2c_*, u32, u32);
...
/* export: 'encode' */
void w2c__encode(w2c_* instance, u32 var_p0, u32 var_p1) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE((*instance->w2c_js_mem).data);
#endif
  w2c__encode_0(instance, var_p0, var_p1);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
}

static void init_instance_import(w2c_* instance, struct w2c_js* w2c_js_instance) {
  instance->w2c_js_mem = w2c_js_mem(w2c_js_instance);
}

const u64 wasm2c__min_js_mem = 1;
const u64 wasm2c__max_js_mem = 65536;
const u8 wasm2c__is64_js_mem = 0;

void wasm2c__instantiate(w2c_* instance, struct w2c_js* w2c_js_instance) {
  assert(wasm_rt_is_initialized());
  init_instance_import(instance, w2c_js_instance);
...
u32 w2c__f0(w2c_* instance, u32 var_p0, u32 var_p1) {
  ...
  if (var_i0) {
    var_i0 = var_p1;
    var_i1 = var_p0;
    i32_store8(instance->w2c_js_mem, (u64)(var_i0), var_i1);
    var_i0 = 1u;
    goto var_Bfunc;
  }
  var_i0 = var_p0;
  ...
  var_i0 = 65533u;
  var_i1 = var_p1;
  var_i0 = w2c__f0(instance, var_i0, var_i1);
  var_Bfunc:;
  FUNC_EPILOGUE;
  return var_i0;
}

void w2c__encode_0(w2c_* instance, u32 var_p0, u32 var_p1) {
  ...
  var_L0: 
    ...
    var_i1 = var_l2;
    var_i0 += var_i1;
    var_i0 = i32_load8_u(instance->w2c_js_mem, (u64)(var_i0));
    var_l4 = var_i0;
    var_i0 = !(var_i0);
