...
A = BeverageConfig("openECSC{TEST_FLAG}")
...
# id(B.alcohol_shelf._alcohol_shelf),id(B._alcohol_shelf)
# (4368672064, 4366184256)
# Clears B.empty_alcohol_shelf() except the last item.
